...
import { getCasesByCountry, Stats } from './api/service'
  ...
  return (
    <div className="App">
      ...
      <div className="Footer">
        <img src="noego.png" className="noego" alt="logo" />
